...
export const metadata: Metadata = buildMetadata({
  title: "Check a List of UK Licensed Sponsors | Annaizu",
  ...
  return (
    <main className="relative min-h-[100dvh] bg-void px-6 py-12 lg:px-16">
      <div className="mx-auto max-w-4xl">
        <h1 className="font-display text-2xl font-semibold text-mist lg:text-3xl">
          Check multiple organisations against the UK sponsor register
        </h1>
